...
root_path = fullfile(root, '2.1.1 Epoched_ET\epoched_info_mat');
out_path = fullfile(root, 'Overview data\');
...
header={'id', 'task', 'nan_percentage','x_mean', 'y_mean', 'x_y_sdd', 'look_proportion'};
